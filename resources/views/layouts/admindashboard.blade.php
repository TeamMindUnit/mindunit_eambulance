    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link"href="searcha">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Search Ambulance Record</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="servicef">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Ambulance Data</span>
            </a>
          </li>
